        ...
        <form action="{{ url()->to($path) }}" class="form-horizontal" method="GET">
          <div class="form-group">
            ...
            <div class="col-md-3">
              ...
              <span class="help-block">Search by Voucher Name and Price</span>
            </div>
          </div>
          <div class="form-group">
...
<!--                 <span class="badge bg-red pull-right">50%</span> -->
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><a href="/backend/public/_host/orders">{{ $field->voucher_name }}</a></td>
                <td>{{ $field->price }}</td>
                <td>{{ $field->expire_days }}</td>
                <td>{{ $field->expire_date }}</td>
                <td>{{ $field->fee_percent }}</td>
                <td>{{ $field->fee_amount }}</td>
                <td>{{ $field->status }}</td>
                <td><a href="/backend/public/_host/orders">Orders!!</a></td>
              ...
              <td>d</td>
              <td>d</td>
              <td><a href="/backend/public/_host/orders">detail click!!</a></td>
              <td class="text-center">
                <a href="/backend/public/_host/voucher/update" class="btn btn-xs btn-circle green"><i class="fa fa-edit"></i></a>
