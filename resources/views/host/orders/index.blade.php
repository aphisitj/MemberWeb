@extends('host.layout.main-layout') @section('page-style') @endsection @section('more-style') @endsection @section('page-title','Orders Page Host') @section('page-content')
<div class="col-md-12">
        ...
        <table class="table table-striped table-bordered table-hover">
          <thead>
            <tr>
              ...
              <th class="text-center">บริการที่ใช้ได้</th>
