          ...
          <thead>
            <tr>
              ...
              <th class="text-center col-sm-2 col-md-2">
                <a href="/backend/public/_host/department/create" class="btn btn-circle blue btn-xs"><i class="fa fa-plus"></i> Add</a>
              </th>
            </tr>
          </thead>
          <tbody>
            ...
            <tr>
              ...
              <td class="text-center">
                <a href="/backend/public/_host/department/update" class="btn btn-xs btn-circle green"><i class="fa fa-edit"></i></a>
