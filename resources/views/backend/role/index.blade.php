                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <th>{!! $obj_fn->sorting('Role Name','role_name',$order_by,$sort_by,$str_param_sort,'') !!}</th>
                                ...
                                @foreach($data as $key => $field)
                                    <tr>
                                        ...
                                        {{--<td class="text-center">--}}
                                            {{--<a href="{{ url()->to('_admin/set-permission?admin_role_id='.$field->$primaryKey) }}" class="btn btn-circle blue btn-xs">Set Permission</a>--}}
                                        {{--</td>--}}
                                        <td class="text-center">
