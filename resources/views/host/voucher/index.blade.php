...
<!--                 <span class="badge bg-red pull-right">50%</span> -->
                <th class="text-center col-sm-1">{!! $obj_fn->sorting('Voucher ID','voucher_id',$order_by,$sort_by,$str_param_sort,'') !!}</th>
                <th>{!! $obj_fn->sorting('Voucher Name','voucher_name',$order_by,$sort_by,$str_param_sort,'') !!}</th>
                <th>{!! $obj_fn->sorting('Detail Short','detail_short',$order_by,$sort_by,$str_param_sort,'') !!}</th>           
