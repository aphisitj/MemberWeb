				...
				<form action="{{ url()->to($url_to) }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
					...
					<div class="form-body">
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<input type="text" class="form-control maxlength" maxlength="300" name="detail_short" value="{{  $detail_short }}">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<textarea class="form-control maxlength" maxlength="500" rows="4" placeholder="Description Voucher..." style="resize: vertical" name="description" value="{{ $description }} "></textarea>
							</div>
						</div>							
					<hr>
